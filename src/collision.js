...
export const objectHeightAt=(o,time)=>(isPickup(o)?2.1:1.4)+(['fish','shark'].includes(o.type)?Math.sin(time*2+(o.phase||0))*.25:0);
...
function relative(s,o,targetD,p){
 ...
 return [dx/(core.x+BIKE_CORE.x),(y+BIKE_CORE.cy-oy-objectHeightAt(o,p.time)-core.cy)/(core.y+BIKE_CORE.y),dz/(core.z+BIKE_CORE.z)];
}
